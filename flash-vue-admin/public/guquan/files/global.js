...
jsImport = function(src,cache){
	...
	switch(src){
		...
		// 	importJavaScript('../artDialog4.1.7/artDialog.js',false);
		// 	importJavaScript('../artDialog4.1.7/plugins/iframeTools.source.js',false);
		// 	improtStyle		('../artDialog4.1.7/skins/default.css');
		// 	break; 
		// }
		default	:{
...
// 	importJavaScript('../artDialog4.1.7/artDialog.js',false);
// 	importJavaScript('../artDialog4.1.7/plugins/iframeTools.source.js',false);
// 	improtStyle		('../artDialog4.1.7/skins/blue.css');
// } 