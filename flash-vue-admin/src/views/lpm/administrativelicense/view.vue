<template>
  <el-row>
    ...
    <el-col v-if="accessoryFilesListAdministrativelicense.length>0" :span="24">
      <FilesListComponent file-title="相关附件" :files-list="accessoryFilesListAdministrativelicense" />
    </el-col>
  </el-row>
</template>
<style lang="scss">
