<template>
  <div style="background-color:#fffff;border:1px #efefef dotted;margin:5px;">
    <div style="padding:5px 10px;">
      ...
      <el-button v-permission="['/newFilesList']" style="border:none;padding:5px;z-index:10;margin:0;margin-left:10px;position:absolute;right:130px;top:40px;" @click="openAllFilesDialog()">
        <img class="user-avatar" title="点击营业执照查看公司文件" src="@/assets/img/zhizhao.png">
        <div style="margin-top:10px;font-size:13px;color:#ccc;">点击营业执照查看公司文件</div>
      </el-button>
