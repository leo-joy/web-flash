<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column :label="$t('businessLicenseMgr.enterpriseName')" width="300">
        <template slot-scope="scope">{{ scope.row.enterpriseName }}</template>
      </el-table-column>
      <el-table-column :label="$t('businessLicenseMgr.enterpriseCode')" width="150">
        <template slot-scope="scope">{{ scope.row.enterpriseCode }}</template>
      </el-table-column>
      <el-table-column prop="type" label="企业类型" width="150" :formatter="formatterEnterpriseType" />
...
<script src="./businesslicense.js"></script>
