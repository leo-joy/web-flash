  ...
  <div class="app-container">
    <div class="block">
      <el-row>
        <el-col :span="24">
          <el-button
            v-permission="['/certificatecancel/add']"
            type="success"
            icon="el-icon-plus"
            size="small"
            @click.native="add"
          ...
          <el-button
            v-permission="['/certificatecancel/edit']"
            type="primary"
            icon="el-icon-edit"
            size="small"
            @click.native="edit"
          ...
          <el-button
            v-permission="['/certificatecancel/delete']"
            type="danger"
            icon="el-icon-delete"
            size="small"
            @click.native="remove"
    ...
    >
      ...
      <el-table-column prop="replaceStatus" label="是否补领" width="150" :formatter="formatterReplaceStatus" />
      <el-table-column label="补领日期" width="150">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="是否正副本">
              <el-select v-model="form.transcriptStatus" placeholder="请选择">
                <el-option
                  v-for="item in transcriptStatusList"
                  :key="item.value"
                  :label="item.label"
                  :value="item.value"
                />
          ...
          <el-col :span="12">
            <el-form-item label="副本编号">
              <el-input v-model="form.transcriptCode" minlength="1" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
          ...
          <el-col :span="12">
            <el-form-item label="是否补领">
              <el-select v-model="form.replaceStatus" placeholder="请选择">
                <el-option
                  v-for="item in replaceStatusList"
                  :key="item.value"
                  :label="item.label"
                  :value="item.value"
                />
          ...
          <el-col :span="24">
            <el-form-item label="声明内容" prop="statementContent">
              <el-input v-model="form.statementContent" minlength="1" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
...
<script src="./certificate_cancel.js"></script>
