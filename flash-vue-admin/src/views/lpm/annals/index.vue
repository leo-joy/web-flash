<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="报送年度" width="100">
        <template slot-scope="scope">{{ scope.row.submissionYear }}</template>
      </el-table-column>
      <el-table-column label="报送日期" width="150">
        <template slot-scope="scope">{{ scope.row.submissionDate.replace(' 00:00:00','') }}</template>
      </el-table-column>
