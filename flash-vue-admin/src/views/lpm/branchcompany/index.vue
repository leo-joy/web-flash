  ...
  <div class="app-container">
    <div class="block">
      <el-row>
        <el-col :span="24">
          <el-button
            v-permission="['/branchcompany/add']"
            type="success"
            icon="el-icon-plus"
            size="small"
            @click.native="add"
          ...
          <el-button
            v-permission="['/branchcompany/edit']"
            type="primary"
            icon="el-icon-edit"
            size="small"
            @click.native="edit"
          ...
          <el-button
            v-permission="['/branchcompany/delete']"
            type="danger"
            icon="el-icon-delete"
            size="small"
            @click.native="remove"
    ...
    >
      <el-table-column label="母公司" width="400">
        <template slot-scope="scope">{{ scope.row.enterpriseName }}</template>
      </el-table-column>
      <el-table-column label="分公司编号" width="100">
    ...
    <el-dialog :title="formTitle" :visible.sync="formVisible" width="60%">
      <el-form ref="form" :model="form" :rules="rules" label-width="150px">
        <el-row>
          ...
          <el-col :span="24" />
          <el-col :span="24">
            <el-form-item label="请选择分公司" prop="branchCompanyName">
              <el-autocomplete
...
<script src="./branch_company.js"></script>
