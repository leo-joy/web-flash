<template>
  <div class="app-container">
    <div class="block">
      <el-row :gutter="20">
        <el-col :span="6">
          <el-input v-model="listQuery.account" placeholder="请输入帐号" />
        </el-col>
        <el-col :span="6">
      ...
      <el-row>
        <el-col :span="24">
          <el-button v-permission="['/mgr/add']" type="success" size="small" icon="el-icon-plus" @click.native="add">
            {{ $t('button.add') }}
          </el-button>
          <el-button v-permission="['/mgr/edit']" type="primary" size="small" icon="el-icon-edit" @click.native="edit">
            {{ $t('button.edit') }}
          </el-button>
          <el-button v-permission="['/mgr/delete']" type="danger" size="small" icon="el-icon-delete" @click.native="remove">
            {{ $t('button.delete') }}
          </el-button>
